    ...
    <aside className="w-70 bg-white border-r border-gray-200 p-5">
      ...
      <nav className="space-y-4">
        <ul className="list-none p-0">
          <li className="text-gray-700 flex items-center gap-5 cursor-pointer hover:bg-gray-100 p-4 rounded-md transition duration-200">
            <button onClick={()=>navigate(`/userdashboard`)}className="flex-1">My Profile</button>
          </li>
          <li className="text-gray-700 flex items-center gap-5 cursor-pointer hover:bg-gray-100 p-4 rounded-md transition duration-200">
          ...
          {/* <li className="text-gray-700 flex items-center gap-2 cursor-pointer hover:bg-gray-100 p-2 rounded-md transition duration-200">
        ...
        <li className="text-gray-700 flex items-center gap-5 cursor-pointer hover:bg-red-100 p-4 rounded-md transition duration-200">
