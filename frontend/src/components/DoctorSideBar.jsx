  ...
  return (
    <aside className="w-70 bg-white border-r border-gray-200 p-5">
       <div className="text-center mb-5">
              ...
              <span className="text-sm text-gray-500">Doctor Panel</span>
            </div>
      <nav className="space-y-6"> {/* Increased space between buttons */}
        <ul className="list-none p-0">
          <li className="text-xl text-gray-700 flex items-center gap-2 cursor-pointer hover:bg-gray-100 p-4 rounded-md transition duration-200">
          ...
          {/* <li className="text-xl text-gray-700 flex items-center gap-2 cursor-pointer hover:bg-red-100 p-4 rounded-md transition duration-200">
