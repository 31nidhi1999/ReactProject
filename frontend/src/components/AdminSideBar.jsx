  ...
  return (
    <aside className="w-70 bg-white border-r border-gray-200 p-5">
      <div className="text-center mb-5">
        <h1 className="text-lg font-bold text-black-1000">ADMIN</h1>
        <span className="text-sm text-gray-500">Dashboard Panel</span>
      </div>
      <nav className="space-y-4">
        <ul className="list-none p-0">
          {/* <li className="text-gray-700 flex items-center gap-4 p-4 cursor-pointer hover:bg-gray-100">
          ...
          <li className="text-gray-700 flex items-center gap-4 p-4 cursor-pointer hover:bg-red-100 hover:bg-gray-100 rounded-md transition duration-200">
